...
class Complete_Aicity_Car196(Dataset):
    ...
    def download(self):
        ...
        meta = {'name': 'Complete_Aicity_Car196', 'shot': 'multiple', 'num_cameras': 41,
